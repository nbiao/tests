package com.example.nb.databasetest;
...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.nb.databasetest.provider";
...
// 删除数据
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.nb.databasetest.provider.book ";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.nb.databasetest.provider.book ";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.nb.databasetest.provider.category ";
            case CATEGORY_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.nb.databasetest.provider.category ";
        }
        return null;
    }
}
